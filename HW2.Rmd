...
k_pred <- kern_coeff * seq(0, 140, length.out = 141)
m_pred <- mojave_coeff * seq(0, 140, length.out = 141)
a_pred <- antelope_coeff * seq(0, 140, length.out = 141)
v_pred <- ventura_coeff * seq(0, 140, length.out = 141)
